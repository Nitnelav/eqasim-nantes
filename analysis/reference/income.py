...
def execute(context):
    ...
    df_egt = context.stage("data.hts.edgt.cleaned")[0][["household_weight", "income_class", "consumption_units"]].copy()
    egt_upper_bounds = data.hts.edgt.cleaned.INCOME_CLASS_BOUNDS
